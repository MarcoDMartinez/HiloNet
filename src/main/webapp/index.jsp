...
<script src="${pageContext.request.contextPath}/recursos/js/paginas/autenticacion/inicio-sesion.js"></script>
<script src="${pageContext.request.contextPath}/recursos/js/paginas/administrador/nucleo-administrador.js"></script>
<script src="${pageContext.request.contextPath}/recursos/js/paginas/administrador/utilidades-administrador.js"></script>
<script src="${pageContext.request.contextPath}/recursos/js/paginas/administrador/vista-pedidos.js"></script>
<script src="${pageContext.request.contextPath}/recursos/js/paginas/administrador/vista-areas.js"></script>
<script src="${pageContext.request.contextPath}/recursos/js/paginas/administrador/vista-usuarios.js"></script>
<script src="${pageContext.request.contextPath}/recursos/js/paginas/administrador/vista-incidencias.js"></script>
<script src="${pageContext.request.contextPath}/recursos/js/paginas/administrador/vista-soporte.js"></script>
